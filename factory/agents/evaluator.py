...
async def run_final_review(
    ...
    prompt = (
        ...
        "   - If the service processes user-supplied data, did the"
        " Developer exercise it against realistic fixtures (the sample"
        " data shipped with the issue, or representative real-world"
        " inputs) — not just toy test cases? Silent failures on real"
        " data are common when tests only cover clean inputs.\n"
